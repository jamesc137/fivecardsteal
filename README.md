...
Use strategy, memory, and timing to draw, steal, or swap cards while keeping your hand secret and in order.  
The twist? You’re allowed to steal cards — and they’re allowed to steal them back… eventually.
...
1. Shuffle the deck and deal 5 cards face down to each player.
2. Cards should be placed left to right in a straight line, face down in front of each player.
3. Each player may look at their cards privately and rearrange them once before the game begins.
4. Once the first player starts, card positions may not change.
5. Place the remaining cards in the center of the table as the draw pile.
6. Leave space next to the draw pile for the discard row — a line of up to five face-up cards.
